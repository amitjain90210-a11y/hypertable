...
### Prerequisites
  ...
  * Install Thrift 0.8.0 Ruby gem

        gem install thrift -v 0.8.0

  * In order for your Ruby program to use the Hypertable Thrift Client interface, you need to tell it where to find it. To do that, add the following lines to the top of your Ruby program:

        require '/opt/hypertable/current/lib/rb/hypertable/thrift_client'
