                     ...
                     String &sample_fname, ::int32_t delete_pct, bool thrift)
{
  ...
  try {
    ...
    boost::timer::progress_display progress_meter(key_limit ? dg.get_max_keys() : adjusted_bytes);
                              ...
                              ::int32_t delete_pct, bool thrift)
{
  ...
  try {
    ...
    boost::timer::progress_display progress_meter(key_limit ?
        ...
        bool to_stdout, ::int32_t delay, String &sample_fname, bool thrift)
{
  ...
  try {
    ...
    Cell cell;
    String config_file = get_str("config");
    boost::timer::progress_display progress_meter(dg.get_max_keys());
        ...
        int32_t parallel)
{
  ...
  boost::timer::progress_display progress(max_keys * parallel);
