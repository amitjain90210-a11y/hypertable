        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.command = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.BOOL:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.e = hyperthrift.gen.ttypes.ClientException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
hql_exec_result.thrift_spec = (
    ...
    (1, TType.STRUCT, 'e', [hyperthrift.gen.ttypes.ClientException, None], None, ),  # 1
)
