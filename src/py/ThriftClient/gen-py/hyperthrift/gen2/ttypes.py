            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i4 in range(_size0):
                        _elem5 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i18 in range(_size14):
                        _elem19 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                ...
                if ftype == TType.LIST:
                    ...
                    for _i24 in range(_size20):
                        ...
                        for _i30 in range(_size26):
                            _elem31 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i39 in range(_size35):
                        _elem40 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                ...
                if ftype == TType.LIST:
                    ...
                    for _i45 in range(_size41):
                        ...
                        for _i51 in range(_size47):
                            _elem52 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
...
HqlResult.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'results', (TType.STRING, 'UTF8', False), None, ),  # 1
    (2, TType.LIST, 'cells', (TType.STRUCT, [hyperthrift.gen.ttypes.Cell, None], False), None, ),  # 2
