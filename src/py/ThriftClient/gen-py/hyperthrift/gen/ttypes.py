...
class RowInterval(object):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.start_row = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.BOOL:
                ...
                if ftype == TType.STRING:
                    self.end_row = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.BOOL:
    ...
    def write(self, oprot):
        ...
        if self.start_row is not None:
            ...
            oprot.writeString(self.start_row.encode('utf-8') if sys.version_info[0] == 2 else self.start_row)
            oprot.writeFieldEnd()
        ...
        if self.end_row is not None:
            ...
            oprot.writeString(self.end_row.encode('utf-8') if sys.version_info[0] == 2 else self.end_row)
            oprot.writeFieldEnd()
...
class CellInterval(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.start_column = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.BOOL:
                ...
                if ftype == TType.STRING:
                    self.end_column = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.BOOL:
    ...
    def write(self, oprot):
        ...
        if self.start_column is not None:
            ...
            oprot.writeString(self.start_column.encode('utf-8') if sys.version_info[0] == 2 else self.start_column)
            oprot.writeFieldEnd()
        if self.start_inclusive is not None:
        ...
        if self.end_column is not None:
            ...
            oprot.writeString(self.end_column.encode('utf-8') if sys.version_info[0] == 2 else self.end_column)
            oprot.writeFieldEnd()
        if self.end_inclusive is not None:
...
class ColumnPredicate(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.column_family = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                    self.column_qualifier = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.I32:
                ...
                if ftype == TType.STRING:
                    self.value = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class ScanSpec(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i16 in range(_size12):
                        _elem17 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                ...
                if ftype == TType.STRING:
                    self.row_regexp = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.STRING:
                    self.value_regexp = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 13:
                if ftype == TType.BOOL:
    ...
    def write(self, oprot):
        ...
        if self.row_regexp is not None:
            ...
            oprot.writeString(self.row_regexp.encode('utf-8') if sys.version_info[0] == 2 else self.row_regexp)
            oprot.writeFieldEnd()
        if self.value_regexp is not None:
            oprot.writeFieldBegin('value_regexp', TType.STRING, 12)
            oprot.writeString(self.value_regexp.encode('utf-8') if sys.version_info[0] == 2 else self.value_regexp)
            oprot.writeFieldEnd()
...
class Key(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.row = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.row is not None:
            ...
            oprot.writeString(self.row.encode('utf-8') if sys.version_info[0] == 2 else self.row)
            oprot.writeFieldEnd()
        if self.column_family is not None:
...
class MutateSpec(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.appname = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.I32:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.error_msg = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i39 in range(_size35):
                        ...
                        for _i45 in range(_size41):
                            _elem46 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
...
class NamespaceListing(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.name = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.BOOL:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.location = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRING:
                    self.ip_address = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
                    self.hostname = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class ColumnFamilySpec(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.access_group = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.BOOL:
    ...
    def write(self, oprot):
        ...
        if self.access_group is not None:
            ...
            oprot.writeString(self.access_group.encode('utf-8') if sys.version_info[0] == 2 else self.access_group)
            oprot.writeFieldEnd()
...
class AccessGroupOptions(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.compressor = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRING:
                    self.bloom_filter = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.BOOL:
    ...
    def write(self, oprot):
        ...
        if self.compressor is not None:
            ...
            oprot.writeString(self.compressor.encode('utf-8') if sys.version_info[0] == 2 else self.compressor)
            oprot.writeFieldEnd()
        if self.bloom_filter is not None:
            oprot.writeFieldBegin('bloom_filter', TType.STRING, 4)
            oprot.writeString(self.bloom_filter.encode('utf-8') if sys.version_info[0] == 2 else self.bloom_filter)
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                if ftype == TType.MAP:
                    ...
                    for _i53 in range(_size49):
                        _key54 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                ...
                if ftype == TType.MAP:
                    ...
                    for _i60 in range(_size56):
                        _key61 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.text = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class ClientException(TException):
    ...
    def __init__(self, code=None, message=None,):
        super(ClientException, self).__setattr__('code', code)
        super(ClientException, self).__setattr__('message', message)
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    message = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
RowInterval.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'start_row', 'UTF8', None, ),  # 1
    (2, TType.BOOL, 'start_inclusive', None, True, ),  # 2
    (3, TType.STRING, 'end_row', 'UTF8', None, ),  # 3
...
CellInterval.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'start_row', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'start_column', 'UTF8', None, ),  # 2
    (3, TType.BOOL, 'start_inclusive', None, True, ),  # 3
    (4, TType.STRING, 'end_row', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'end_column', 'UTF8', None, ),  # 5
...
ColumnPredicate.thrift_spec = (
    ...
    (2, TType.STRING, 'column_qualifier', 'UTF8', None, ),  # 2
...
ScanSpec.thrift_spec = (
    ...
    (8, TType.LIST, 'columns', (TType.STRING, 'UTF8', False), None, ),  # 8
    (9, TType.BOOL, 'keys_only', None, False, ),  # 9
    (10, TType.I32, 'cell_limit_per_family', None, 0, ),  # 10
    (11, TType.STRING, 'row_regexp', 'UTF8', None, ),  # 11
    (12, TType.STRING, 'value_regexp', 'UTF8', None, ),  # 12
...
Key.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'row', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'column_family', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'column_qualifier', 'UTF8', None, ),  # 3
...
ResultAsArrays.thrift_spec = (
    ...
    (5, TType.I32, 'error', None, None, ),  # 5
    (6, TType.STRING, 'error_msg', 'UTF8', None, ),  # 6
    (7, TType.LIST, 'cells', (TType.LIST, (TType.STRING, 'UTF8', False), False), None, ),  # 7
)
...
TableSplit.thrift_spec = (
    ...
    (4, TType.STRING, 'ip_address', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'hostname', 'UTF8', None, ),  # 5
)
...
ColumnFamilySpec.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'name', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'access_group', 'UTF8', None, ),  # 2
...
AccessGroupOptions.thrift_spec = (
    ...
    (3, TType.STRING, 'compressor', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'bloom_filter', 'UTF8', None, ),  # 4
...
Schema.thrift_spec = (
    None,  # 0
    (1, TType.MAP, 'access_groups', (TType.STRING, 'UTF8', TType.STRUCT, [AccessGroupSpec, None], False), None, ),  # 1
    (2, TType.MAP, 'column_families', (TType.STRING, 'UTF8', TType.STRUCT, [ColumnFamilySpec, None], False), None, ),  # 2
