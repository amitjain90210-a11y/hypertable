        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.ns = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.e = ClientException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.table_name = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i85 in range(_size81):
                        ...
                        for _i91 in range(_size87):
                            _elem92 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                ...
                if ftype == TType.LIST:
                    ...
                    for _i99 in range(_size95):
                        ...
                        for _i105 in range(_size101):
                            _elem106 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                ...
                if ftype == TType.LIST:
                    ...
                    for _i127 in range(_size123):
                        ...
                        for _i133 in range(_size129):
                            _elem134 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                ...
                if ftype == TType.LIST:
                    ...
                    for _i141 in range(_size137):
                        ...
                        for _i147 in range(_size143):
                            _elem148 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
...
get_row_args.thrift_spec = (
    ...
    (1, TType.I64, 'ns', None, None, ),  # 1
    (2, TType.STRING, 'table_name', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'row', 'UTF8', None, ),  # 3
)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i162 in range(_size158):
                        ...
                        for _i168 in range(_size164):
                            _elem169 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.column = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
get_cell_args.thrift_spec = (
    ...
    (2, TType.STRING, 'table_name', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'row', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'column', 'UTF8', None, ),  # 4
)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i183 in range(_size179):
                        ...
                        for _i189 in range(_size185):
                            _elem190 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                ...
                if ftype == TType.LIST:
                    ...
                    for _i211 in range(_size207):
                        ...
                        for _i217 in range(_size213):
                            _elem218 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
...
shared_mutator_set_cells_as_arrays_args.thrift_spec = (
    ...
    (2, TType.STRING, 'table_name', 'UTF8', None, ),  # 2
    (3, TType.STRUCT, 'mutate_spec', [MutateSpec, None], None, ),  # 3
    (4, TType.LIST, 'cells', (TType.LIST, (TType.STRING, 'UTF8', False), False), None, ),  # 4
)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i225 in range(_size221):
                        ...
                        for _i231 in range(_size227):
                            _elem232 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i239 in range(_size235):
                        _elem240 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
...
shared_mutator_set_cell_as_array_args.thrift_spec = (
    ...
    (2, TType.STRING, 'table_name', 'UTF8', None, ),  # 2
    (3, TType.STRUCT, 'mutate_spec', [MutateSpec, None], None, ),  # 3
    (4, TType.LIST, 'cell', (TType.STRING, 'UTF8', False), None, ),  # 4
)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i246 in range(_size242):
                        _elem247 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i253 in range(_size249):
                        _elem254 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
...
mutator_set_cell_as_array_args.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'mutator', None, None, ),  # 1
    (2, TType.LIST, 'cell', (TType.STRING, 'UTF8', False), None, ),  # 2
)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i260 in range(_size256):
                        _elem261 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
...
set_cell_as_array_args.thrift_spec = (
    ...
    (1, TType.I64, 'ns', None, None, ),  # 1
    (2, TType.STRING, 'table_name', 'UTF8', None, ),  # 2
    (3, TType.LIST, 'cell', (TType.STRING, 'UTF8', False), None, ),  # 3
)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i281 in range(_size277):
                        ...
                        for _i287 in range(_size283):
                            _elem288 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
...
mutator_set_cells_as_arrays_args.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'mutator', None, None, ),  # 1
    (2, TType.LIST, 'cells', (TType.LIST, (TType.STRING, 'UTF8', False), False), None, ),  # 2
)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i295 in range(_size291):
                        ...
                        for _i301 in range(_size297):
                            _elem302 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
...
set_cells_as_arrays_args.thrift_spec = (
    ...
    (1, TType.I64, 'ns', None, None, ),  # 1
    (2, TType.STRING, 'table_name', 'UTF8', None, ),  # 2
    (3, TType.LIST, 'cells', (TType.LIST, (TType.STRING, 'UTF8', False), False), None, ),  # 3
)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i309 in range(_size305):
                        _elem310 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i316 in range(_size312):
                        _elem317 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                ...
                if ftype == TType.LIST:
                    ...
                    for _i337 in range(_size333):
                        ...
                        for _i343 in range(_size339):
                            _elem344 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                ...
                if ftype == TType.LIST:
                    ...
                    for _i351 in range(_size347):
                        ...
                        for _i357 in range(_size353):
                            _elem358 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
...
class table_get_id_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRING:
                    self.success = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            elif fid == 1:
                if ftype == TType.STRUCT:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i365 in range(_size361):
                        _elem366 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.new_name = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readBinary().decode('utf-8', errors='replace')
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
rename_table_args.thrift_spec = (
    ...
    (1, TType.I64, 'ns', None, None, ),  # 1
    (2, TType.STRING, 'name', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'new_name', 'UTF8', None, ),  # 3
)
